...
import it.csi.sicee.siceefree.dto.main.CpHomeHomeModel;
...
import it.csi.sicee.siceefree.presentation.siceefree.action.main.states.CpHomeHomeScreenStates;
...
/**
 * CpHomeHomeAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpHomeHomeAction extends AbstractCPAction<CpHomeHomeModel>
		implements
			Preparable,
			ModelDriven<CpHomeHomeModel> {
	 ...
	 * strato di business.
	 */
	public CpHomeHomeModel getModel() {
		return model;
	}
	...
	public void setModel(CpHomeHomeModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpHomeHome";
	...
	public Class modelClass() {
		return it.csi.sicee.siceefree.dto.main.CpHomeHomeModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-781876364) ENABLED START*/
