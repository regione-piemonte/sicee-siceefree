...
import it.csi.sicee.siceefree.dto.main.CpHomeModel;
...
import it.csi.sicee.siceefree.presentation.siceefree.action.main.states.CpHomeScreenStates;
...
public class CpHomeAction extends AbstractCPAction<CpHomeModel> implements Preparable, ModelDriven<CpHomeModel> {
	...
	public Class modelClass() {
		return it.csi.sicee.siceefree.dto.main.CpHomeModel.class;
	}
	...
	/**
	 * Gestione dell'evento CLICKED sul widget [btnCittadini]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleBtnCittadini_CLICKED() throws CommandExecutionException {

		return handleEventInternal("main", "cphome", "btnCittadini", "CLICKED");

	}

	/**
	 * Gestione dell'evento CLICKED sul widget [btnNotai]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleBtnNotai_CLICKED() throws CommandExecutionException {

		return handleEventInternal("main", "cphome", "btnNotai", "CLICKED");
