...
import it.csi.sicee.siceefree.dto.certificatore.CpDettaglioCertificatoreModel;
...
import it.csi.sicee.siceefree.presentation.siceefree.action.certificatore.states.CpDettaglioCertificatoreScreenStates;
...
public class CpDettaglioCertificatoreAction extends AbstractCPAction<CpDettaglioCertificatoreModel>
	...
	public Class modelClass() {
		return it.csi.sicee.siceefree.dto.certificatore.CpDettaglioCertificatoreModel.class;
	}
	...
	/**
	 * Gestione dell'evento CLICKED sul widget [btnScaricaCV]
	 */
	@MethodProtection(level = "REJECT_SAME")
	public String handleBtnScaricaCV_CLICKED() throws CommandExecutionException {

		return handleEventInternal("certificatore", "cpdettagliocertificatore", "btnScaricaCV", "CLICKED");
	...
	public String handleBtnIndietro_CLICKED() throws CommandExecutionException {
		...
		return handleEventInternal("certificatore", "cpdettagliocertificatore", "btnIndietro", "CLICKED");
