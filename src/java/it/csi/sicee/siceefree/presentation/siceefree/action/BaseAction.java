...
public abstract class BaseAction<T extends BaseSessionAwareDTO> extends ActionSupport
	...
	static {
		...
		MenuStructure mnuRicercaAceMenu = new MenuStructure("mnuRicercaAce");

		mnuHomeMenu.getSubmenus().add(mnuRicercaAceMenu);
		MenuStructure mnuRicercaCertificatoreMenu = new MenuStructure("mnuRicercaCertificatore");

		mnuHomeMenu.getSubmenus().add(mnuRicercaCertificatoreMenu);
	...
	private it.csi.sicee.siceefree.business.BackEndFacade backEnd = null;

	public void setSpringBackEnd(it.csi.sicee.siceefree.business.BackEndFacade be) {
		backEnd = be;
	}

	public it.csi.sicee.siceefree.business.BackEndFacade getSpringBackEnd() {
		return backEnd;
	}

	private it.csi.sicee.siceefree.business.SecurityHelper securityHelper = null;

	public void setSpringSecurityHelper(it.csi.sicee.siceefree.business.SecurityHelper sh) {
		securityHelper = sh;
	}

	public it.csi.sicee.siceefree.business.SecurityHelper getSpringSecurityHelper() {
