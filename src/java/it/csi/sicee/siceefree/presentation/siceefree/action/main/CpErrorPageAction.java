...
import it.csi.sicee.siceefree.dto.main.CpErrorPageModel;
...
import it.csi.sicee.siceefree.presentation.siceefree.action.main.states.CpErrorPageScreenStates;
...
/**
 * CpErrorPageAction Action Class.
 *
 * @author GuiGen
 */
@Validation()
@Conversion()
public class CpErrorPageAction extends AbstractCPAction<CpErrorPageModel>
		implements
			Preparable,
			ModelDriven<CpErrorPageModel> {
	 ...
	 * strato di business.
	 */
	private CpErrorPageModel model;
	 ...
	 * strato di business.
	 */
	public CpErrorPageModel getModel() {
		return model;
	}
	...
	public void setModel(CpErrorPageModel modello) {
		this.model = modello;
	}
	 ...
	 */
	private static final String CP_NAME = "cpErrorPage";
	...
	public Class modelClass() {
		return it.csi.sicee.siceefree.dto.main.CpErrorPageModel.class;
	}
	...
	public void validate() {
		/*PROTECTED REGION ID(R-1694733067) ENABLED START*/
