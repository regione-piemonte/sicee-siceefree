...
public class Mail implements java.io.Serializable {
	...
	// il serial version uid e' fisso in quanto la classe in oggetto e'
	// serializzabile
	// solo per la clusterizzazione della sessione web e non viene scambiata con
	// altre
	// componenti.
	...
	public String toString() {
		...
		// / inserire qui la logica desiderata per la rappresenatazione a
		// stringa
