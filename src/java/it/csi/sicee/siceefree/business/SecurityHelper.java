...
public class SecurityHelper {
	...
	protected it.csi.sicee.siceefree.dto.common.UserInfo getCurrentUserInfo(Map session) throws BEException {
		it.csi.sicee.siceefree.dto.common.UserInfo userInfo = (it.csi.sicee.siceefree.dto.common.UserInfo) session
	...
	public boolean verifyCurrentUserForUC(Map session, String useCaseCode) throws BEException {
		...
		try {
			it.csi.sicee.siceefree.dto.common.UserInfo currentUserInfo = getCurrentUserInfo(session);
