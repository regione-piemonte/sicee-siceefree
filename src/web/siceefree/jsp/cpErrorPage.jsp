...
<s:form id="cpErrorPage" action="cpErrorPage" namespace="/base/main" method="post">
...
<s:if test="isWidgetVisible('cpErrorPage','menu')" >
	...
	<!-- endFragment:p_pLeft --></div>
		...
		<div id="centerPanel">
			...
			<div class="wrapper">
				...
				<h3><s:text name="cpErrorPage.pMain.label" /></h3>
